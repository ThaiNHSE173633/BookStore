...
public class ShoppingController extends HttpServlet {
    ...
    private final String ADDCARTSERVLET = "AddItemController";
    private final String VIEWCARTPAGE = "viewCart.jsp";
    private final String REMOVECARTSERVLET = "RemoveItemController";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (action) {
            ...
            case "View Cart": {
                RequestDispatcher rd = request.getRequestDispatcher(VIEWCARTPAGE);
                rd.forward(request, response);
                break;
            }
